...
class Monkey():
    ...
    def analysis_log(self):
        ...
        with open('monkeylog.txt', 'r') as f:
            content = f.read()
            if content.find('java.lang.NoClassDefFoundError') == -1:
                print '没有出现java.lang.NoClassDefFoundError'
            else:
                print 'java.lang.NoClassDefFoundError出现在第{}个字符'.format(content.find('java.lang.NoClassDefFoundError'))
